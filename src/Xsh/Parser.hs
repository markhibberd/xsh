...
--
-- Execuse the stringy error message, these can be done much better,
-- megaparsec allows for typed error messages and stores a complete
-- annotated doc for the error message. String is just done in haste.
--
